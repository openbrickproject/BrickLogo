...
pub fn cmd_motor_speed(port: u8, speed: i32) -> String {
    format!(
        "port {} ; select 0 ; pid {} 0 0 s1 1 0 0.15 0.06 0 100 0.01 ; set {}\r",
        port, port, speed
    )
}
...
pub fn cmd_motor_pulse(port: u8, speed: i32, seconds: f64) -> String {
    format!(
        "port {} ; select 0 ; pid {} 0 0 s1 1 0 0.15 0.06 0 100 0.01 ; set pulse {} 0.0 {} 0\r",
...
pub fn cmd_motor_ramp(port: u8, from_pos: f64, to_pos: f64, duration: f64) -> String {
    format!(
        "port {} ; select 0 ; pid {} 0 1 s4 0.0027777778 0 5 0 .1 3 0.01 ; set ramp {} {} {} 0\r",
