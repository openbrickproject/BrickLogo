...
impl App {
    ...
    pub fn help_lines(&self) -> Vec<String> {
        let mut lines = vec![
            ...
            "    local \"name                          Declare local variable".to_string(),
            "    localmake \"name <value>              Declare and set local variable".to_string(),
            "    :name                                Get a variable".to_string(),
            "    print <value>  /  show <value>       Output a value".to_string(),
            "    repeat <n> [...]                     Repeat commands".to_string(),
            "    foreach \"var <list> [...]            Iterate over list".to_string(),
            "    while [...] [...]                    Loop while condition true".to_string(),
            "    until [...] [...]                    Loop until condition true".to_string(),
