...
| LEGO Interface A | `connectto "interfacea "name` | Motors and sensors via [BrickInterface](https://github.com/openbrickproject/BrickInterface) or [TC Logo Connect](https://www.tc-logo.com/) (USB) |
